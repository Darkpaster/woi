...
import QuestWindow from "../features/quests/QuestWindow.tsx";
import WowFriendList from "../features/friends/WowFriendList.tsx";
...
export const InGame = () => {
    ...
    return (
        !loading ? (<div id="interface-layer">
            ...
            {/*{*/}
            {isCharMenuOpen && <WowFriendList></WowFriendList>}
            {
