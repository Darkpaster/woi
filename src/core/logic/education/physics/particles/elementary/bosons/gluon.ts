...
export class Gluon extends Boson {
    ...
    private readonly colorCharge: [string, string]; // Цвет и анти-цвет глюона
    ...
    constructor(position: Vector2D, color1: string = 'red', color2: string = 'blue') {
        ...
        this.velocity = new Vector2D((Math.random() - 0.5) * 100,(Math.random() - 0.5) * 100);
    }
    ...
    draw(ctx: CanvasRenderingContext2D): void {
        ...
        try {
            ...
            console.log(e.toString()); //CanvasRenderingContext2D.createLinearGradient: Argument 1 is not a finite floating-point value.
        }
